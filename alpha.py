...
def labels():
	...
	header=Label(main_window,text="The Rock Paper Scissors Game",font=("Impact",18))
...
def displays():
	...
	m_display=Entry(main_window,width=5)
...
def buttons():
	...
	rock_bt=Button(main_window,text="ROCK",width=15,height=2,pady=5,padx=5,command=click_rock)
	paper_bt=Button(main_window,text="PAPER",width=15,height=2,pady=5,padx=5,command=click_paper)
	scissors_bt=Button(main_window,text="SCISSORS",width=15,height=2,pady=5,padx=5,command=click_scissors)
	
	reset_bt=Button(main_window,text="Reset",command=click_reset)
...
def click_rock():
	...
	cpu_select=1
	if(cpu_select==1):
		if(cpu_choice=="rock" and entry=="paper"):
			user_points=user_points+1
			m_display.delete(0,END)
			m_display.insert(0,"1") # updated text 
			...
			u_display.insert(0,"1") 
			winner_is.delete(0,END)
			winner_is.insert(0,"CPU Won!")
			says_now.delete(0,END)
			says_now.insert(0,cpu_choice)
			pointupdate=True
		elif(cpu_choice=="rock" and entry=="rock"):
		...
		if(cpu_choice=="paper" and entry=="scissors"):
			user_points=user_points+1
			m_display.delete(0,END)
			m_display.insert(0,"1") # updated text 
			winner_is.delete(0,END)
			...
			says_now.insert(0,cpu_choice)
			pointupdate=True
		elif(cpu_choice=="paper" and entry=="paper"):
			cpu_points=cpu_points
			user_points=user_points
			winner_is.delete(0,END)
			winner_is.insert(0,"Draw")
		...
		if(cpu_choice=="scissors" and entry=="rock"):
			user_points=user_points+1
			m_display.delete(0,END)
			m_display.insert(0,"1") # updated text 
			winner_is.delete(0,END)
			...
			says_now.insert(0,cpu_choice)
			pointupdate=True
		elif(cpu_choice=="scissors" and entry=="scissors"):
			cpu_points=cpu_points
			user_points=user_points
			winner_is.delete(0,END)
			winner_is.insert(0,"Draw")
